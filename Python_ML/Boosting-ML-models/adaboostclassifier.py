...
decision_stump = DecisionTreeClassifier(max_depth = 1) #aim for decision stump which has only 2 leaf nodes
...
y_pred = ada_classifier.predict(X_test)  #predict the classes of the testing dataset
