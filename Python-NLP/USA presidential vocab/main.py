...
#print(processed_speeches[0]) #first inaugural address
#print(processed_speeches[0][0]) #first sentence in the first inaugural address 
#print(processed_speeches[0][0][0]) #first word of the first sentence in the first inaugural address
...
print("Printing the most frequent words: ")
